...
const loadExistingResume = useCallback(async () => {
  ...
  const changeResumeVisibility = async () => {
    try {
      ...
      console("Error saving resume:", error)
    }
  };
  ...
  const saveResume = async()=>{
    try {
      ...
      //remove image from updatedResumeDta
        ...
        <div className="grid lg:grid-cols-12 gap-8">
          ...
          <div className="relative lg:col-span-5 rounded-lg overflow-hidden">
            <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6 pt-1">
              ...
              <hr
                className="absolute top-0 left-0 h-1 bg-linear-to-r from-pink-500 to-pink-600 border-none transition-all duration-2000"
                style={{
                  width: `${
              ...
              <button onClick={()=>{toast.promise(saveResume, {loading: 'Saving...'})}} className="bg-linear-to-br from-pink-100 to-pink-200 ring-pink-300 text-pink-700 ring hover:ring-pink-400 transition-all rounded-md px-6 py-2 mt-6 text-sm">
                Save Changes
              </button>
            </div>
          </div>
