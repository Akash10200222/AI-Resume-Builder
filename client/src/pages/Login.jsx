...
const Login = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      // NOTE: endpoints use /api/user/...  -> must match server routes (confirm in userRoutes.js)
  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-gray-50 px-4">
      ...
      >
        ...
        <button
          type="submit"
          className="mt-4 w-full h-11 rounded-full text-white bg-pink-500 hover:opacity-90 transition-opacity"
        >
          {state === 'login' ? 'Login' : 'Sign up'}
        </button>
        ...
        <p className="text-gray-500 text-sm mt-3 mb-11">
          ...
          <button onClick={toggleState} className="text-pink-500 hover:underline">
            click here
          </button>
        </p>
      </form>
