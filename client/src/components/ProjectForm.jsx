  ...
  return (
    <div>
        <div className='flex items-center justify-between'>
            ...
            <button onClick={addProject} className='flex items-center gap-2 px-3 py-1 text-sm bg-green-100 text-green-700 rounded-lg hover:bg-purple-200 transition-colors'>
                ...
                {data.map((project, index)=> (
                    <div key={index} className='p-4 border border-gray-200 rounded-lg space-y-3'>
                        ...
                        <div className='grid gap-3'>
                            ...
                            <textarea rows={4} value={project.description || ""} onChange={(e)=> updateProject(index, "description", e.target.value)}  placeholder='Describe your porject...' className='w-full px-3 py-2 text-sm rounded-lg resize-none' />
