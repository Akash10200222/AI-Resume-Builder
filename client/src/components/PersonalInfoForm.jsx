...
const PersonalInfoForm = ({data, onChange, removeBackground, setRemoveBackground}) => {
  ...
  return (
    <div>
        <h3 className='text-lg font-semibold text-gray-900'>Personal Informatin</h3>
        ...
        <div className='flex items-center gap-2'>
            <label>
                ...
                <input type="file" accept="image/jpeg, image/png" className="hidden" onClick={(e)=>handleChange("image", e.target.files[0])}/>
            </label>
            {
                typeof data.image === 'object' && (
                    <div className='flex flex-col gap-1 pl-4 text-sm'>
                        ...
                        <label className='relative inline-flex items-center cursor-pointer text-gray-900 gap-3'>
                            ...
                            <div className='w-9 h-5 bg-slate-300 rounded-full peer peer-checked:bg-pink-600 transition-colors duration-200'>
