...
const Features = () => {
  ...
  return (
    <div id='features' className='flex flex-col items-center my-10 scroll-mt-12'>
        ...
        <Title title='Build your resume' description='Quickly create a professional resume using our efficient, AI-enhanced process and powerful features.'/>
                    ...
                    <div className={"flex items-center justify-center gap-6 max-w-md group"}>
                        <div className={`p-6 group-hover:bg-violet-100 border border-transparent group-hover:border-violet-300  flex gap-4 rounded-xl transition-colors ${!isHover ? 'border-violet-300 bg-violet-100' : ''}`}>
                            ...
                            <div className="space-y-2">
                                <h3 className="text-base font-semibold text-slate-700">Live Resume Preview</h3>
                                <p className="text-sm text-slate-600 max-w-xs">Build and refine your resume instantly with live previews and smart insights.</p>
                            </div>
                        </div>
                    </div>
                    <div className="flex items-center justify-center gap-6 max-w-md group">
                        <div className="p-6 group-hover:bg-green-100 border border-transparent group-hover:border-green-300 flex gap-4 rounded-xl transition-colors">
                            ...
                            <div className="space-y-2">
                                ...
                                <p className="text-sm text-slate-600 max-w-xs">Your resume data is encrypted, protected, and never shared without consent.</p>
                            </div>
                        </div>
                    </div>
                    <div className="flex items-center justify-center gap-6 max-w-md group">
                        <div className="p-6 group-hover:bg-orange-100 border border-transparent group-hover:border-orange-300 flex gap-4 rounded-xl transition-colors">
                            ...
                            <div className="space-y-2">
                                <h3 className="text-base font-semibold text-slate-700">Custom Resume Exports</h3>
                                <p className="text-sm text-slate-600 max-w-xs">Export professional, recruiter-ready resumes in one click.</p>
                            </div>
                        </div>
                    </div>
                </div>
